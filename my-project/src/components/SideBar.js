        ...
        <div className='bg-[#4E73DF] h-screen px-[25px]'>
            ...
            <div className='pt-[15px] border-b-[1px] border-[#EDEDED]/[0.3]'>
                ...
                <div className='flex items-center gap-[10px] py-[15px]'>
                    ...
                    <p className='text-[14px] leading-[20px] font-normal text-white'>Tablets</p>
                </div>
            </div>
            ...
            <div className='bg-[#395CBF] mt-[15px] flex items-center justify-center flex-col py-[15px] px-[10px] gap-[15px] rounded-[3px]'>
                <FaBolt color='white'/>
                <p className='text-[12px] leading-[18px] font-normal text-white/[0.4] text-center'>Include popular icons in your React projects easily with react-icons</p>
